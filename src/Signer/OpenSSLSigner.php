...
use Pioniro\OrangeData\Exception\OrangeDataException;
...
class OpenSSLSigner implements SignerInterface
{
    ...
    {
        $sign = "";
        $r = openssl_sign($data, $sign, $this->privateKey, OPENSSL_ALGO_SHA256);
        if (!$r) {
            throw new OrangeDataException('Bad sign');
        }
